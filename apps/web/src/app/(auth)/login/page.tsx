    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-500 mt-1">ペットの健康を毎日スコアで管理</p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Button variant="outline" className="w-full focus:ring-2 focus:ring-emerald-500" onClick={handleGoogleLogin} aria-label="Googleアカウントでログイン">
