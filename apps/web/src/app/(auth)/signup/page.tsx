      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <button
            ...
            className="mt-4 text-sm text-emerald-600 hover:underline focus:outline-none focus:ring-2 focus:ring-emerald-500 rounded"
            aria-label="別のメールアドレスで登録しなおす"
          >
            別のメールアドレスで登録
          </button>
        </div>
      ...
      <div className="w-full max-w-sm">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Button variant="outline" className="w-full focus:ring-2 focus:ring-emerald-500" onClick={handleGoogleLogin} aria-label="Googleアカウントで登録">
